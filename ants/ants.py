...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        distance = 0
        while not current_place.is_hive and distance <= self.upper_bound:
            if current_place.bees and distance >= self.lower_bound:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        copied_bees = list(self.place.bees)
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        "*** YOUR CODE HERE ***"
        if not (self.ant_contained or other.is_container):
            return True
        return False
        # END Problem 8a
...
class LaserAnt(ThrowerAnt):
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem EC 4
        return max(self.damage - distance / 4 - self.insects_shot / 16, 0)
        # END Problem EC 4
